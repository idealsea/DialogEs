...
function DialogEs(content,obj) {
    ...
    var id = this.id = 'dialog' + new Date().getTime();
    ...
    this.hide2 = obj.hide2 || function (ev) {
        var e = ev || event;
        var $target = $(e.target);
        // $("#"+id).hide();
...
DialogEs.prototype.render = function () {
    ...
    var htmlConstructor =
        '<div onclick=\'('+ this.hide2 +')('+ abc +')\' id="'+ this.id +'" class="dialog-especial-mask '+ maskOffClickClassName +'" style="'+ this.maskStyle +'">\
    ...
    $(this.parent).append(htmlConstructor);
    // });
